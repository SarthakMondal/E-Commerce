...
{
    private String clientid = "TheRefroDrinkgnix_ClientId";
    private String clientSecret = "TheRefroDrinkgnix_secret";
    private String privateKey = "TheRefroDrinkgnix_Key";
    private String publicKey = "TheRefroDrinkgnix_Key";
